...
function Estoque() {
    ...
    return (
        <>
            <div>
                <button className="bg-red-500 hover:bg-red-700 text-white flex flex-row items-center justify-center py-4 px-4 rounded-b-3xl font-bold h-16 w-[100%] " onClick={voltar}>
                    <span>Voltar</span>
                </button>
            </div>
